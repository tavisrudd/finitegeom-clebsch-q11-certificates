...
London Mathematical Society* (2) 44 (1991), doi:10.1112/jlms/s2-44.2.270.
The imported statements are the ten-point bound in Section 2.2 and the equality
classification in Theorem 1(ii), both on page 275. The small-arc bridge reduces the four-, five-,
